                    ...
                    <div class="mt-5 space-y-4 text-sm">
                        @if (settings('office_address'))
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-navy-900">{{ __('Office') }}</p>
                                    <div class="mt-0.5 whitespace-pre-line text-slate-600">{{ settings('office_address') }}</div>
                                </div>
                            </div>
                        @endif
                        @if (settings('phone_primary'))
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-navy-900">{{ __('Phone') }}</p>
                        ...
                        @if (settings('email_primary'))
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-navy-900">{{ __('Email') }}</p>
                                    <div class="mt-0.5 text-slate-600">
                        ...
                        @if (settings('business_hours'))
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-navy-900">{{ __('Business hours') }}</p>
                                    <div class="mt-0.5 text-slate-600">{{ settings('business_hours') }}</div>
                                </div>
                            </div>
                        @endif
                    </div>
